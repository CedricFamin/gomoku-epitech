...
namespace Patterns
{
	PatternInfos patterns[PATTERNNUMBER] = 
	{
		...
		PatternInfos(ox,   1, 0, 0, 1, 2),
		PatternInfos(o_x,  1, 1, 1, 1, 3),
		PatternInfos(_ox,  0, 1, 0, 2, 3),
		PatternInfos(o__x, 1, 2, 1, 1, 4),
		PatternInfos(_o_x, 0, 2, 1, 2, 4),
		PatternInfos(__ox, 0, 2, 0, 3, 4),
		...
		PatternInfos(oox,  2, 0, 0, 1, 3),
		PatternInfos(oo_x, 2, 2, 1, 1, 4),
		PatternInfos(_oox, 1, 1, 0, 2, 4),
		PatternInfos(o_ox, 1, 1, 1, 1, 4),
		PatternInfos(ooo_, 3, 0, 1, 1, 4),
		PatternInfos(_ooo, 0, 1, 0, 2, 4),
		PatternInfos(oo_o, 2, 1, 1, 1, 4),
		PatternInfos(o_oo, 1, 1, 1, 1, 4),
		PatternInfos(oooo, 4, 0, 0, 1, 4),
		PatternInfos(ooox, 3, 0, 0, 1, 4)
	};
}